...
This ECS implementation is modified from the original version used in Neighborly.
It is not thread-safe and assumes that everything happens sequentially on the same
thread.

There is no external documentation for this ECS. All public classes, properties, and
methods have doc comments to help ease confusion.
